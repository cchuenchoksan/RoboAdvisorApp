  ...
  const options = {
    ...
    plotOptions: {
      heatmap: {
        ...
        colorScale: {
          ranges: [
            { from: -1.0, to: -0.7, color: '#c0392b', name: "Strong Negative" },   // Dark red
            { from: -0.7, to: -0.4, color: '#e74c3c', name: "Medium Negative" },   // Medium red
            { from: -0.4, to: -0.1, color: '#f39c12', name: "Weak Negative" },     // Orange
            { from: -0.1, to: 0.1, color: '#f1c40f', name: "Neutral" },            // Yellow
            { from: 0.1, to: 0.4, color: '#27ae60', name: "Weak Positive" },       // Light green
            { from: 0.4, to: 0.7, color: '#2ecc71', name: "Medium Positive" },     // Medium green
            { from: 0.7, to: 1.0, color: '#16a085', name: "Strong Positive" },     // Dark green
          ],
        },
      },
    },
